...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <link href="/open/Application/Ucenter/Static/css/center.css" type="text/css" rel="stylesheet">
    <section>
        <div class="col-xs-12 col-sm-offset-1 register clearfix" style="margin-top: 50px;margin-bottom: 110px;background-color: white;padding: 10px;">
            <div class="col-xs-12"><h1 style="font-size: 18px;color: #333333;"><?php echo L('_REGISTER_WELCOME_'); echo modC('WEB_SITE_NAME',L('_OPENSNS_'),'Config'); echo L('_ACCOUNT_');?></h1></div>
            ...
            <?php if($step == 'start'): ?><div class="col-xs-6">
                    <form class="" action="/open/index.php?s=/ucenter/member/register.html" method="post">
...
<script src="/open/Public/js/ext/lazyload/lazyload.js"></script>
        ...
        var DecTime = {
            ...
            dec_time : function(){
                if(this.time > 0){
                    ...
                    this.obj.text("<?php echo L('_PHONE_VERIFY_');?>")
    ...
    <link href="/open/Application/Core/Static/css/form_check.css" rel="stylesheet" type="text/css">
    <script src='/open/Application/Core/Static/js/form_check.js'></script>
    <script>
        // 验证密码长度
        $(function(){
