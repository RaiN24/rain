...
<script src="/open/Public/js.php?f=js/jquery-2.0.3.min.js,js/com/com.functions.js,js/core.js,js/com/com.toast.class.js,js/com/com.ucard.js"></script>
    ...
    <link href="/open/Application/Ucenter/Static/css/center.css" rel="stylesheet" type="text/css"/>
    <link href="/open/Application/Ucenter/Static/css/usercenter.css" rel="stylesheet" type="text/css"/>
...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <?php if($user_info['cover_id']): ?><img class="uc_top_img_bg" src="<?php echo ($user_info['cover_path']); ?>" style="width: 100%;height: 100%">
        <?php else: ?>
        <img class="uc_top_img_bg" src="/open/Application/Ucenter/Static/images/user_top_default_bg.jpg" style="width: 100%;height: 100%"><?php endif; ?>
    <?php if(is_login() && $user_info['uid'] == is_login()): ?><div class="change_cover"><a data-type="ajax" data-url="<?php echo U('Ucenter/Public/changeCover');?>" data-toggle="modal" data-title="<?php echo L('_UPLOAD_PERSONAL_COVER_');?>" style="color: white;"><img class="img-responsive" src="/open/Application/Core/Static/images/fractional.png"></a>
        </div><?php endif; ?>
</div>
