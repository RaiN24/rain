...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <section>
        ...
        <div class="common_block_border login-form-inbox ">
            <div class="login-text"><strong><h1><?php echo L('_SEND_MAIL_PASSWORD_FOUND_');?></h1></strong></div>
            <form class="login-form" id="J_findpwd_form" action="<?php echo U('Member/mi');?>" method="post">
                <div class="control-group login-input">


                    <div class="controls">
                        <input type="text" id="inputEmail" class="form-control" placeholder="<?php echo L('_PLACEHOLDER_USERNAME_INPUT_');?>"
                               ajaxurl="/member/checkUserNameUnique.html" errormsg="<?php echo L('_MI_USERNAME_ERROR_');?>" nullmsg="<?php echo L('_MI_USERNAME_');?>"
                               datatype="*4-32" value="" name="username">
                    </div>
                </div>
                <div class="control-group login-input">
